...
//prusa filament sensor support
#define PRUSA_FILAMENT_SENSOR
#define PRUSA_FILAMENT_SENSOR_ADDRES 0x75
#define PRUSA_FILAMENT_SENSOR_XRES 240
#define PRUSA_FILAMENT_SENSOR_YRES 240
#define PRUSA_FILAMENT_SENSOR_INVERSE  //inverse X Y data
#define PRUSA_FILAMENT_SENSOR_MM_KX 0.0245 //for mm output 
#define PRUSA_FILAMENT_SENSOR_MM_KY 0.0245
...
#define TMC2130_FACTOR 1
#define TMC2130_SG_THR_0       5 * TMC2130_FACTOR
#define TMC2130_SG_THR_1       6 * TMC2130_FACTOR
#define TMC2130_SG_THR_2       1 * TMC2130_FACTOR
...
// currents
#define CURRENT_MULTIPLIER 1.1 // 1 for 24V ~1.8 for 12V
#define CURRENT_HOLDING_STEALTH {1*CURRENT_MULTIPLIER, 7*CURRENT_MULTIPLIER, 16*CURRENT_MULTIPLIER}
#define CURRENT_HOLDING_NORMAL {1*CURRENT_MULTIPLIER, 10*CURRENT_MULTIPLIER, 22*CURRENT_MULTIPLIER}
#define CURRENT_RUNNING_STEALTH {35*CURRENT_MULTIPLIER, 35*CURRENT_MULTIPLIER, 35*CURRENT_MULTIPLIER}
#define CURRENT_RUNNING_NORMAL {30*CURRENT_MULTIPLIER, 35*CURRENT_MULTIPLIER, 35*CURRENT_MULTIPLIER}
#define CURRENT_HOMING {1*CURRENT_MULTIPLIER, 35*CURRENT_MULTIPLIER, 30*CURRENT_MULTIPLIER}
